<?php 
    ...
    */
    ...
    $allowedAddresses = array('127.0.0.1'); // Az alapból megadott telefonszámok a netfizetéstől érkező IP címek (Ezért azért kell hogy random ipkről ne lehessen ppt addolni.)
